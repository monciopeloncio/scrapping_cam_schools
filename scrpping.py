...
def get_page_results(page: int):
    ...
    PARAM_URL = f'http://www.educa.jccm.es/educacion/cm/educa_jccm/BBDD_ACCESS.1.1.tkContent.27265/tkListResults?formName=SQLQueriesSearcher&nshow.sqlResults={page}&position.sqlResults=0&idQuery=961'
...
df.to_csv('cam_schools.csv', index=False, encoding='utf-8')
